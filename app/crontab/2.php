                ...
                try {
                    ...
                    if (strpos($login_success, 'main') !== false) {
                        ...
                        */
                        ...
                        //                    Log::channel('datareportfenliang')->info('百度账号[' . $projectArray['userName'] . ']成功 - 项目[' . $projectArray['clientName'] . ']'.$campaignFeed['message']);


                        //                 } else {
                                  
                        //                     Log::channel('datareportfenliang')->info('百度账号[' . $projectArray['userName'] . ']失败 - 项目[' . $projectArray['clientName'] . ']'.$campaignFeed['message']);
                        //                 }
                        //             }
                        //          }
                        //     }
                                       ...
                                       foreach($validProjects as $project_item){
                                           ...
                                           if(!$updatetime){   
                                              ...
                                              $projectArray = (array) $project_item; 
                                                ...
                                                Log::channel('datareportfenliang')->info('百度账号[' . $projectArray['userName'] . '] - 项目失败[' . $projectArray['clientName'] . ']'.$campaignFeed['message']);
                                            }
                                           }
                                        }
                                   }
